...
Aucun bourrage : chaque mot-clé apparaît dans le title, le H1 ou les H2, puis naturellement dans le texte.

## Accueil `/`
- **Principaux :** couvreur Aude, devis toiture Aude
- Secondaires : rénovation toiture Aude, charpentier Aude, artisan couvreur 11, couverture Aude
- Longue traîne : trouver un couvreur dans l'Aude, réfection toiture Aude

## Pages villes (intention « couvreur + ville » / « rénovation toiture + ville »)

| Page | Mots-clés principaux | Secondaires / longue traîne |
|---|---|---|
| `/couvreur-carcassonne/` | couvreur Carcassonne, rénovation toiture Carcassonne | couverture Carcassonne, charpente Carcassonne, tuile canal, démoussage toiture Carcassonne |
| `/couvreur-narbonne/` | couvreur Narbonne, rénovation toiture Narbonne | couverture Narbonne, charpentier Narbonne, gouttières littoral, démoussage toiture Narbonne |
| `/couvreur-castelnaudary/` | couvreur Castelnaudary, rénovation toiture Castelnaudary | charpente Lauragais, tuiles vent d'autan, démoussage toiture Castelnaudary |
| `/couvreur-lezignan-corbieres/` | couvreur Lézignan-Corbières, rénovation toiture Lézignan | charpente maison vigneronne, couverture tuile canal, démoussage toiture Lézignan |
| `/couvreur-limoux/` | couvreur Limoux, rénovation toiture Limoux | charpente Limoux, couverture haute vallée de l'Aude, démoussage toiture Limoux |
| `/couvreur-coursan/` | couvreur Coursan, rénovation toiture Coursan | couverture plaine narbonnaise, charpente fermettes, démoussage toiture Coursan |
| `/couvreur-port-la-nouvelle/` | couvreur Port-la-Nouvelle, rénovation toiture bord de mer | gouttières anti-corrosion, couverture littoral, nettoyage toiture Port-la-Nouvelle |
| `/couvreur-sigean/` | couvreur Sigean, rénovation toiture Sigean | charpente ancienne, tuiles de réemploi, démoussage toiture Sigean |
| `/couvreur-trebes/` | couvreur Trèbes, rénovation toiture Trèbes | charpente Trèbes, couverture canal du Midi, démoussage toiture Trèbes |
...
## À faire côté référencement local (hors code)
1. Créer/optimiser la fiche **Google Business Profile** (catégories « Couvreur » + « Charpentier », zone desservie = villes ci-dessus, tél. 06 18 24 47 25).
2. Inscriptions annuaires locaux cohérentes (NAP identique : nom, téléphone, email).
3. Collecter des avis clients Google et y répondre.
4. Soumettre `sitemap.xml` dans Google Search Console.
